<template>
  <div class="indexpage">
    ...
    <div class="d-guide">
      <div>1.申请立项理由</div>
      <div>2.国内、外研究现状和趋势</div>
      <div>3.研究目标和预期成果</div>
      <div>4.项目主要内容</div>
      <div>5.研究思路、方法和计划进度</div>
      <div class="stepOn">6.工作基础和科研保障情况</div>
      <div>7.主要研究人员</div>
      <div>8.项目研究单位及合作单位</div>
      <div>9.附件</div>
    </div>
    <div>
      <h1 class="pagetitle">
...
.d-guide
  ...
  >div
    ...
    cursor pointer
  div.stepOn
    background rgba(80, 167, 255, 0.19)
    color #50A7FF
.pagetitle
  text-align center
.contentbox

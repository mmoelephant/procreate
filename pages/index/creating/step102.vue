<template>
  <div class="indexpage">
    <div class="contentbox">
      ...
      <div class="content">
        <h1 class="pagetitle central">申报单位</h1>
        <div class="formitems">
          <div class="formitem">
          ...
          <div class="formitem">
            <div class="itemname">联系地址</div>
            <input
              v-model="form.linkaddre"
              type="text"
              :disabled="disabled1"
              placeholder="请输入联系地址"
            />
...
export default {
  ...
  methods: {
    next() {
      this.$router.push('/creating/step112')
    },
    pagechange(val) {},
    edit() {
